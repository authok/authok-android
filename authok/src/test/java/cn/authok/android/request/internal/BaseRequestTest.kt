...
public class BaseRequestTest {
    ...
    private val readAuthokException = AuthokException("read")
    private val readRawAuthokException = AuthokException("read-raw")
    private val wrappingAuthokException = AuthokException("wrapping")
    ...
    public fun setUp() {
        ...
        errorAdapter = Mockito.spy(object : ErrorAdapter<AuthokException> {
            override fun fromJsonResponse(statusCode: Int, reader: Reader): AuthokException {
                reader.read() // Read to trigger exception thrown by Reader, if any
                return readAuthokException
            }
            ...
            override fun fromRawResponse(
                ...
                return readRawAuthokException
            }

            override fun fromException(cause: Throwable): AuthokException {
                return wrappingAuthokException
            }
    ...
    public fun shouldBuildErrorFromException() {
        ...
        } catch (e: AuthokException) {
            exception = e
        }
        MatcherAssert.assertThat(exception, Matchers.`is`(wrappingAuthokException))
    ...
    public fun shouldBuildErrorFromUnsuccessfulJsonResponse() {
        ...
        var exception: AuthokException? = null
        var result: SimplePojo? = null
        try {
            result = baseRequest.execute()
        } catch (e: AuthokException) {
        ...
        MatcherAssert.assertThat(result, Matchers.`is`(Matchers.nullValue()))
        MatcherAssert.assertThat(exception, Matchers.`is`(readAuthokException))
    ...
    public fun shouldBuildErrorFromUnsuccessfulRawResponse() {
        ...
        MatcherAssert.assertThat(result, Matchers.`is`(Matchers.nullValue()))
        MatcherAssert.assertThat(exception, Matchers.`is`(readRawAuthokException))
