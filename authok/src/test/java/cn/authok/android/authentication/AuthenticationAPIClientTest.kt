package cn.authok.android.authentication

import android.content.Context
import android.content.res.Resources
import cn.authok.android.Authok
import cn.authok.android.authentication.ParameterBuilder.Companion.newBuilder
...
import cn.authok.android.result.*
import cn.authok.android.util.AuthokUserAgent
import cn.authok.android.util.AuthenticationAPIMockServer
import cn.authok.android.util.AuthenticationCallbackMatcher
import cn.authok.android.util.MockAuthenticationCallback
...
public class AuthenticationAPIClientTest {
    ...
    public fun setUp() {
        ...
        val authok = authok
        client = AuthenticationAPIClient(authok)
    ...
    public fun shouldUseCustomNetworkingClient() {
        ...
        argumentCaptor<RequestOptions>().apply {
            verify(networkingClient).load(eq("https://tenant.cn.authok.cn/oauth/token"), capture())
    ...
    public fun shouldCreateClientWithAccountInfo() {
        val client = AuthenticationAPIClient(Authok(CLIENT_ID, DOMAIN))
    ...
    public fun shouldCreateClientWithContextInfo() {
        ...
        val client = AuthenticationAPIClient(Authok(context))
        assertThat(client, Matchers.`is`(Matchers.notNullValue()))
    ...
    public fun shouldLoginWithMFAOTPCode() {
        ...
        val authok = authok
        val client = AuthenticationAPIClient(authok)
        ...
        assertThat(
            body,
            Matchers.hasEntry("grant_type", "http://authok.cn/oauth/grant-type/mfa-otp")
        )
    ...
    public fun shouldLoginWithMFARecoveryCode() {
        ...
        assertThat(
            body,
            Matchers.hasEntry("grant_type", "http://authok.cn/oauth/grant-type/mfa-recovery-code")
        )
        assertThat(body, Matchers.hasEntry("mfa_token", "ey30.the-mfa-token.value"))
    ...
    public fun shouldLoginWithMFAOOBCode() {
        ...
        assertThat(
            body,
            Matchers.hasEntry("grant_type", "http://authok.cn/oauth/grant-type/mfa-oob")
        )
        assertThat(body, Matchers.hasEntry("mfa_token", "ey30.the-mfa-token.value"))
    ...
    public fun shouldLoginWithUserAndPasswordSync() {
        ...
        val credentials = client
            .login(SUPPORT_AUTHOK_COM, "voidpassword", MY_CONNECTION)
            .execute()
        ...
        assertThat(
            body,
            Matchers.hasEntry("grant_type", "http://authok.cn/oauth/grant-type/password-realm")
        )
        assertThat(body, Matchers.hasEntry("client_id", CLIENT_ID))
        assertThat(body, Matchers.hasEntry("username", SUPPORT_AUTHOK_COM))
    }
    ...
    public fun shouldLoginWithPasswordRealmGrant() {
        ...
        val authok = authok
        val client = AuthenticationAPIClient(authok)
        client.login(SUPPORT_AUTHOK_COM, "some-password", MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        assertThat(
            callback, AuthenticationCallbackMatcher.hasPayloadOfType(
    ...
    public fun shouldLoginWithUserAndPasswordUsingOAuthTokenEndpoint() {
        mockAPI.willReturnSuccessfulLogin()
        val callback = MockAuthenticationCallback<Credentials>()
        client.login(SUPPORT_AUTHOK_COM, "some-password")
            .start(callback)
        ShadowLooper.idleMainLooper()
        assertThat(
            callback, AuthenticationCallbackMatcher.hasPayloadOfType(
    ...
    public fun shouldLoginWithUserAndPasswordSyncUsingOAuthTokenEndpoint() {
        mockAPI.willReturnSuccessfulLogin()
        val credentials = client
            .login(SUPPORT_AUTHOK_COM, "some-password")
            .execute()
        assertThat(credentials, Matchers.`is`(Matchers.notNullValue()))
        val request = mockAPI.takeRequest()
        assertThat(request.path, Matchers.`is`("/oauth/token"))
    ...
    public fun shouldLoginWithEmailOnlyWithCustomConnectionWithOTPGrant() {
        ...
        val client = AuthenticationAPIClient(authok)
        val callback = MockAuthenticationCallback<Credentials>()
        client.loginWithEmail(SUPPORT_AUTHOK_COM, "1234", MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldLoginWithEmailOnlyWithOTPGrant() {
        ...
        val client = AuthenticationAPIClient(authok)
        val callback = MockAuthenticationCallback<Credentials>()
        client.loginWithEmail(SUPPORT_AUTHOK_COM, "1234")
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldLoginWithEmailOnlySyncWithOTPGrant() {
        ...
        val client = AuthenticationAPIClient(authok)
        val credentials = client
            .loginWithEmail(SUPPORT_AUTHOK_COM, "1234")
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldCreateUserWithUserMetadata() {
        ...
        client.createUser(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION, testMetadata)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
        ...
        val body = bodyFromRequest<Any>(request)
        assertThat(body, Matchers.hasEntry("email", SUPPORT_AUTHOK_COM))
    ...
    public fun shouldCreateUserWithUserMetadataSync() {
        ...
        val testMetadata = mapOf("country" to "argentina", "age" to "23")
        val user = client
            .createUser(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION, testMetadata)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldCreateUserWithUsername() {
        mockAPI.willReturnSuccessfulSignUp()
        val callback = MockAuthenticationCallback<DatabaseUser>()
        client.createUser(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldCreateUserWithUsernameSync() {
        mockAPI.willReturnSuccessfulSignUp()
        val user = client
            .createUser(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldCreateUserWithoutUsername() {
        mockAPI.willReturnSuccessfulSignUp()
        val callback = MockAuthenticationCallback<DatabaseUser>()
        client.createUser(email = SUPPORT_AUTHOK_COM, PASSWORD, connection = MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldCreateUserWithoutUsernameSync() {
        mockAPI.willReturnSuccessfulSignUp()
        val user = client
            .createUser(email = SUPPORT_AUTHOK_COM, PASSWORD, connection = MY_CONNECTION)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldNotSendNullUsernameOnSignUp() {
        mockAPI.willReturnSuccessfulSignUp()
        val callback = MockAuthenticationCallback<DatabaseUser>()
        client.createUser(SUPPORT_AUTHOK_COM, PASSWORD, null, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldNotSendNullUsernameOnSignUpSync() {
        mockAPI.willReturnSuccessfulSignUp()
        val user = client.createUser(SUPPORT_AUTHOK_COM, PASSWORD, null, MY_CONNECTION)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldLoginWithUsernameSignedUpUserWithPasswordRealmGrant() {
        ...
        val authok = authok
        val client = AuthenticationAPIClient(authok)
        client.signUp(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
        ...
        assertThat(loginBody, Matchers.hasEntry("username", SUPPORT_AUTHOK_COM))
    ...
    public fun shouldSignUpUserWithUserMetadata() {
        ...
        val testMetadata = mapOf("country" to "argentina", "age" to "23")
        val credentials = client
            .signUp(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION, testMetadata)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldSignUpUserSync() {
        mockAPI.willReturnSuccessfulSignUp()
            ...
            .willReturnUserInfo()
        val credentials = client
            .signUp(SUPPORT_AUTHOK_COM, PASSWORD, SUPPORT, MY_CONNECTION)
            .execute()
        val request = mockAPI.takeRequest()
        assertThat(
            request.getHeader("Accept-Language"), Matchers.`is`(
    ...
    public fun shouldSignUpUserWithoutUsername() {
        mockAPI.willReturnSuccessfulSignUp()
            ...
            .willReturnUserInfo()
        val callback = MockAuthenticationCallback<Credentials>()
        client.signUp(email = SUPPORT_AUTHOK_COM, password = PASSWORD, connection = MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldChangePassword() {
        ...
        client.resetPassword(SUPPORT_AUTHOK_COM, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldSendEmailCodeWithCustomConnection() {
        ...
        val callback = MockAuthenticationCallback<Void>()
        client.passwordlessWithEmail(SUPPORT_AUTHOK_COM, PasswordlessType.CODE, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldSendEmailCode() {
        mockAPI.willReturnSuccessfulPasswordlessStart()
        val callback = MockAuthenticationCallback<Void>()
        client.passwordlessWithEmail(SUPPORT_AUTHOK_COM, PasswordlessType.CODE)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldSendEmailLink() {
        mockAPI.willReturnSuccessfulPasswordlessStart()
        val callback = MockAuthenticationCallback<Void>()
        client.passwordlessWithEmail(SUPPORT_AUTHOK_COM, PasswordlessType.WEB_LINK)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldSendEmailLinkWithCustomConnection() {
        mockAPI.willReturnSuccessfulPasswordlessStart()
        val callback = MockAuthenticationCallback<Void>()
        client.passwordlessWithEmail(SUPPORT_AUTHOK_COM, PasswordlessType.WEB_LINK, MY_CONNECTION)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldSendEmailLinkAndroid() {
        mockAPI.willReturnSuccessfulPasswordlessStart()
        val callback = MockAuthenticationCallback<Void>()
        client.passwordlessWithEmail(SUPPORT_AUTHOK_COM, PasswordlessType.ANDROID_LINK)
            .start(callback)
        ShadowLooper.idleMainLooper()
        val request = mockAPI.takeRequest()
        assertThat(
    ...
    public fun shouldFetchProfileAfterLoginRequest() {
        ...
        client.getProfileAfter(client.login(SUPPORT_AUTHOK_COM, "voidpassword", MY_CONNECTION))
            .start(callback)
        ShadowLooper.idleMainLooper()
    ...
    private val authok: Authok
        get() {
            val authok = Authok(CLIENT_ID, mockAPI.domain, mockAPI.domain)
    ...
    private companion object {
        ...
        private const val DOMAIN = "samples.authok.cn"
        private const val PASSWORD = "123123123"
        private const val SUPPORT_AUTHOK_COM = "support@authok.cn"
        ...
        private const val COMPANY = "Authok"
