...
public class ParameterBuilderTest {
    ...
    public void shouldSetAudience() {
        Map<String, String> parameters = builder.setAudience("https://domain.authok.cn/api").asDictionary();
        assertThat(parameters, hasEntry("audience", "https://domain.authok.cn/api"));
    }
