...
public class AuthenticationExceptionTest {
    ...
    public fun shouldGetUnknownCode() {
        ...
        MatcherAssert.assertThat(
            ex.getCode(),
            CoreMatchers.`is`(CoreMatchers.equalTo(AuthokException.UNKNOWN_ERROR))
        )
    }
    ...
    public fun shouldReturnNullIfMapDoesNotExist() {
        ...
        val ex3 = AuthenticationException("code", AuthokException("message"))
