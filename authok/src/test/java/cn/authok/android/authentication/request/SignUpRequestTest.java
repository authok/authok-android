...
public class SignUpRequestTest {
    ...
    public void shouldSetAudience() {
        final AuthenticationRequest req = signUpRequest.setAudience("https://domain.authok.cn/api");
        verify(authenticationMockRequest).setAudience("https://domain.authok.cn/api");
        assertThat(req, is(notNullValue()));
