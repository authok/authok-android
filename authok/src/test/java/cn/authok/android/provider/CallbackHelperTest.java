...
public class CallbackHelperTest {
    ...
    private static final String PACKAGE_NAME = "cn.authok.lock.android.app";
    private static final String INVALID_DOMAIN = "not.-valid-domain";
    private static final String DOMAIN = "https://my-domain.authok.cn";
    private static final String DOMAIN_WITH_TRAILING_SLASH = "https://my-domain.authok.cn/";
    ...
    public void shouldGetCallbackURI() {
        ...
        assertThat(result, hasHost("my-domain.authok.cn"));
    ...
    public void shouldGetCallbackURIWithCustomScheme() {
        final Uri expected = Uri.parse("myapp://" + "my-domain.cn.authok.cn" + "/android/" + PACKAGE_NAME + "/callback");
    ...
    public void shouldParseQueryValues() {
        String uriString = "https://test.cn.authok.cn/android/cn.authok.android.lock.app/callback?code=soMec0d3ML8B&state=810132b-486aa-4aa8-1768-a1dcd3368fae";
    ...
    public void shouldReturnEmptyQueryValues() {
        String uriString = "https://test.cn.authok.cn/android/cn.authok.android.lock.app/callback?";
        Uri uri = Uri.parse(uriString);
        final Map<String, String> values = CallbackHelper.getValuesFromUri(uri);
