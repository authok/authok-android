...
public class CustomTabsOptionsTest {
    ...
    public void shouldSetBrowserPicker() {
        ...
        BrowserPickerTest.setupBrowserContext(activity, Collections.singletonList("cn.authok.browser"), null, null);
        ...
        assertThat(preferredPackageBefore, is("cn.authok.browser"));
        ...
        assertThat(preferredPackageNow, is("cn.authok.browser"));
    }
}