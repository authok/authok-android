...
public class CallbackMatcher<T, U extends AuthokException> extends BaseMatcher<MockCallback<T, U>> {
    ...
    public static <T, U extends AuthokException> Matcher<MockCallback<T, U>> hasPayloadOfType(Class<T> tClazz, Class<U> uClazz) {
    ...
    public static <T, U extends AuthokException> Matcher<MockCallback<T, U>> hasNoPayloadOfType(Class<T> tClazz, Class<U> uClazz) {
