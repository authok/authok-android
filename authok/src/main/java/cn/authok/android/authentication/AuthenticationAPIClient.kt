...
import cn.authok.android.request.internal.*
import cn.authok.android.request.internal.GsonAdapter.Companion.forMap
import cn.authok.android.request.internal.GsonAdapter.Companion.forMapOf
...
/**
 * API client for Authok Authentication API.
 * ```
 * val authok = Authok("YOUR_CLIENT_ID", "YOUR_DOMAIN")
 * val client = AuthenticationAPIClient(authok)
 * ```
 *
 * @see [Auth API docs](https://docs.authok.cn/docs/auth-api)
 */
public class AuthenticationAPIClient @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE) internal constructor(
    ...
    /**
     * Creates a new API client instance providing Authok account info.
     *
     * Example usage:
     *
     * ```
     ...
     */
    public constructor(authok: Authok) : this(
        authok,
        RequestFactory<AuthenticationException>(authok.networkingClient, createErrorAdapter()),
        GsonProvider.gson
    )
     ...
     *
     * Requires your client to have the **MFA OTP** Grant Type enabled. See [Client Grant Types](https://docs.authok.cn/docs/clients/client-grant-types) to learn how to enable it.
     *
     * Example usage:
     *
     *```
     ...
     * The MFA token tells the server the username or email, password, and realm values sent on the first request.
     *
     * Requires your client to have the **MFA OOB** Grant Type enabled. See [Client Grant Types](https://docs.authok.cn/docs/clients/client-grant-types) to learn how to enable it.
     *
     * Example usage:
     *
     *```
     ...
     * The MFA token tells the server the username or email, password, and realm values sent on the first request.
     *
     * Requires your client to have the **MFA** Grant Type enabled. See [Client Grant Types](https://docs.authok.cn/docs/clients/client-grant-types) to learn how to enable it.
     *
     * Example usage:
     *
     *```
    ...
    /**
     * Log in a user using a token obtained from a Native Social Identity Provider, such as Facebook, using ['\oauth\token' endpoint](https://docs.authok.cn/docs/api/authentication#token-exchange-for-native-social)
     * The default scope used is 'openid profile email'.
     *
     * Example usage:
     *
     ...
     * @param tokenType the subject token type that is associated with this Identity Provider. e.g. 'http://authok.cn/oauth/token-type/facebook-session-access-token'
     * @return a request to configure and start that will yield [Credentials]
     */
     ...
     * @param verificationCode  sent by Authok via SMS
     ...
     * @param verificationCode  sent by Authok via Email
     * @param realmOrConnection to end the passwordless authentication on
     * @return a request to configure and start that will yield [Credentials]
     */
    @JvmOverloads
    ...
    /**
     * Creates a user in a DB connection using ['/dbconnections/signup' endpoint](https://docs.authok.cn/docs/api/authentication#signup)
     *
     * Example usage:
     * ```
    ...
    /**
     * Request a reset password using ['/dbconnections/change_password'](https://docs.authok.cn/docs/api/authentication#change-password)
     *
     * Example usage:
     *
     * ```
     ...
     * Your Authok Application Type should be set to 'Native' and Token Endpoint Authentication Method must be set to 'None'.
     *
     * Example usage:
     *
     * ```
    ...
    /**
     * Start a passwordless flow with an [Email](https://authok.cn/docs/api/authentication#get-code-or-link).
     *
     * Your Application must have the **Passwordless OTP** Grant Type enabled.
     *
     * Example usage:
    ...
    /**
     * Start a passwordless flow with a [SMS](https://docs.authok.cn/docs/api/authentication#get-code-or-link)
     *
     ...
     *
     * @param authenticationRequest that will authenticate a user with Authok and return a [Credentials]
    ...
    /**
     * Fetch the token information from Authok, using the authorization_code grant type
     * The authorization code received from the Authok server and the code verifier used
    ...
    /**
     * Creates a new Request to obtain the JSON Web Keys associated with the Authok account under the given domain.
     * Only supports RSA keys used for signatures (Public Keys).
     *
     * @return a request to obtain the JSON Web Keys associated with this Authok account.
     */
    ...
    init {
        val authokUserAgent = authok.authokUserAgent
        factory.setAuthokClientInfo(authokUserAgent.value)
    }
}