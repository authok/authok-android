...
import cn.authok.android.result.OptionalCredentials
...
public class SecureCredentialsManager @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE) internal constructor(
     ...
     * @param apiClient the Authok Authentication API Client to handle token refreshment when needed.
    ...
    internal companion object {
        ...
        private const val KEY_CREDENTIALS = "cn.authok.credentials"
        private const val KEY_EXPIRES_AT = "cn.authok.credentials_access_token_expires_at"
        private const val KEY_CACHE_EXPIRES_AT = "cn.authok.credentials_expires_at"
        private const val KEY_CAN_REFRESH = "cn.authok.credentials_can_refresh"
