...
/**
 * Represent a request that creates a user in a Authok Database connection and then logs in.
 */
 ...
 */(
     ...
     *
     * @see [User Metadata documentation](https://docs.authok.cn/docs/users/concepts/overview-user-metadata)
     */
