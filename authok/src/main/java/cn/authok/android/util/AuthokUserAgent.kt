...
/**
 * Responsible for building the custom user agent header data sent on requests to Authok.
 */
public class AuthokUserAgent public constructor(
    ...
    public companion object {
        public const val HEADER_NAME: String = "Authok-Client"
        private const val NAME_KEY = "name"
        private const val VERSION_KEY = "version"
        private const val ENV_KEY = "env"
        private const val LIBRARY_VERSION_KEY = "authok.android"
