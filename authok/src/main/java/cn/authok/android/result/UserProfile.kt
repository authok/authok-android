...
/**
 * Class that holds the information of a user's profile in Authok.
 * Used both in [cn.authok.android.management.UsersAPIClient] and [cn.authok.android.authentication.AuthenticationAPIClient].
 */
