...
import cn.authok.android.authok.R;
...
public abstract class AuthProvider {
    ...
    public void onRequestPermissionsResult(@NonNull Activity activity, int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (declinedPermissions.isEmpty()) {
            ...
            String message = String.format(activity.getString(R.string.cn_authok_webauth_permission_missing_description), declinedPermissions);
            Dialog permissionDialog = new AlertDialog.Builder(activity)
                    .setTitle(R.string.cn_authok_webauth_permission_missing_title)
                    .setMessage(message)
