...
public object WebAuthProvider {
     ...
     */
    @JvmStatic
    public fun logout(account: Authok): LogoutBuilder {
     ...
     */
    @JvmStatic
    public fun login(account: Authok): Builder {
    ...
    public class LogoutBuilder internal constructor(private val account: Authok) {
         ...
         * the [Log Users Out of Identity Provider](https://docs.authok.cn/docs/logout/log-users-out-of-idps) article.
         *
         * @return the current builder instance
         */
    ...
    public class Builder internal constructor(private val account: Authok) {
         ...
         * Defaults to the value returned by [Authok.getDomainUrl].
         *
